<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?color=%2336BCF7&center=true&vCenter=true&lines=R+A+K+H+A+ +P+U+T+R+A+ +A+N+D+R+I+A+N" />
</p>
...
```html
  wget -qO- -O vpsroot.sh https://raw.githubusercontent.com/yanzwrt/Mantap/main/vpsroot.sh && bash vpsroot.sh
